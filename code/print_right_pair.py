...
def according_valid_dc_generate_message_pair(Value_in,ROUNDS,strat_rnd,diff_start,diff_end,state = 320,rate=64):
    ...
    for r in range(ROUNDS +1):
        ...
        if r < ROUNDS-1 +1 :
            ...
            diff = [Value_in[i] +Value_out[i] for i in range(state)]
            print("##############################################")
            print("alpha{}: ".format(r+strat_rnd+1))
            print_state(diff)
            print("##############################################")
...
if __name__ == '__main__':
   ...
   ############# dc ############## 
    ...
    according_valid_dc_generate_message_pair(Value_in, args.rounds,args.stratrnd, diff_bit_lists[0], diff_bit_lists[-1])
